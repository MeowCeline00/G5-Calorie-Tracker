document.addEventListener('DOMContentLoaded', function() {
  ...
  function calculateWithTotalCalories() {
    // Get the total calories from the page
    const totalCalories = document.querySelector('.cal1 span').textContent;
    
    // Redirect to the calculate page with total calories as query parameter
    window.location.href = `calculate.html?totalCalories=${totalCalories}`;
}

// Add event listener to the "Calculate Calories" button
